...
(* OASIS_START *)
(* DO NOT EDIT (digest: a563588ddbbf13bd6e31193382a03548) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Result"; "Xml"; "Superblock"; "Mapping"; "Device"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "dmthin";
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\221\004\189K\"\151\169!\152E8\149\138\245\238\135";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
